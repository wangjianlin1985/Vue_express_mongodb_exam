        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="right">
                    ...
                    <div class="chat active-chat" data-chat="person2">
                        <div :class="{'bubble':true,'you':item.username !== userdata.username, 'me':item.username === userdata.username}" v-for="(item,index) in chats" :key="index">
                            ...
                            <div class="head">
                                <img :src="'/api'+item.headPortrait" height="50"/>
                            </div>
                            {{item.msg}}
                        </div>
                ...
                <div class="student-list">
                    <div class="student" v-for="(item,index) in students" :key="index">
                        <img :src="'api'+item.headPortrait" alt="" />
...
export default {
    ...
    methods: {
        ...
        send() {
            ...
            this.$http.post('/api/teacher/sendmessage',sD).then(res=>{
                console.log(res);
                document.getElementById('bot').scrollIntoView(true);
                this.sendData='';
            })
        ...
        getClass(){
            const _this = this;
            this.$http.post('/api/teacher/getclass',{token:localStorage.getItem('token')}).then(res=>{
    ...
    #teacher-chat{
        ...
        .student-list{
            ...
            .student{
                ...
                &:hover{
                    background-color: rgb(139, 138, 172);
                }
                img{
                    width: 40px;
                    height: 40px;
